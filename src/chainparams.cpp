...
{
    const char* pszTimestamp = "The date is 6/7/2022";
    const CScript genesisOutputScript = CScript() << ParseHex("04800539ece4880048207c7f3376685df445a3c18fd89c9a7b586c4ff084a525044492e8489a93d5ba60c1c017ada31e24bb989941e0d7bbddcf5f2083a50f48e6") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("zontreck.dev."); // Pieter Wuille, only supports x1, x5, x9, and xd
